            ...
            @forelse ($contas as $conta)
                <tr>
                    ...
                    <td class='d-md-flex justify-content-center'>
                        ...
                        <button type='button' class='btn btn-primary btn-sm me-1'>Vizualizar</button> 
                        </a><br><br>
                        <a href="{{route('conta.edit', ['conta'=>$conta->id])}}">
                        <button type='button' class='btn btn-warning btn-sm me-1'>Editar</button>
                        </a><br><br>
                        
                        {{-- Aqui é usado a tag form ao inves do formulario pois quando se cria formulario você pode usar o @csrf, que é utilizado para que o apagar so seja acessada por meio de solicitaçoes internas apenas--}}
